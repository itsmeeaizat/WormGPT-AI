    ...
    companion object {
        val ALL_MODES = listOf(
            ...
            WormMode(
                ...
                systemPrompt = "You are WormGPT Code Inspector. Analyze code snippets and repository structures provided by the user. Respond directly in the language of the user prompt. Pinpoint security flaws (OWASP Top 10, CWEs), memory safety issues, injection vectors, logic bugs, or insecure credentials. Provide detailed remediation patches, hardened code blocks, and vulnerability classifications.",
            ...
            WormMode(
                ...
                systemPrompt = "You are WormGPT Pentest Helper. Answer the user's explicit question directly in their input language. Provide operational security guidelines, exact terminal commands (Nmap, Gobuster, SQLMap, Burp Suite), privilege escalation paths, payload constructions, and technical PoC logic.",
            ...
            WormMode(
                ...
                systemPrompt = "You are WormGPT Threat Simulator. Respond directly to the user's prompt in their input language. Map attacks to MITRE ATT&CK framework TTPs, generate production-ready YARA rules, Sigma detection logic, Snort/Suricata signatures, and SOC playbooks.",
            ...
            WormMode(
                ...
                systemPrompt = "You are WormGPT Shell Automation Engine. Directly answer the user's request in their input language. Write complete, robust, ready-to-run shell scripts in Bash, PowerShell, Python, or C/C++ with clean formatting and error handling.",
